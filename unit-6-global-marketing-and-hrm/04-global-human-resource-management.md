# Unit 6 — Global Human Resource Management (GHRM)

## 1. Introduction
Exploring **Global Human Resource Management (GHRM)** and the integration of marketing, R&D, and staffing policies (Ethnocentric, Polycentric, Geocentric).
