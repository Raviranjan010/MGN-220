# Unit 4 — Introduction to Strategy and Structure

## 1. Introduction
Understanding **Introduction to Strategy and Structure** and how global integration vs local responsiveness pressure shapes organizational architecture.
